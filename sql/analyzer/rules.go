...
const (
	...
	applyProceduresId
	assignRoutinesId
	modifyUpdateExprsForJoin
	applyRowUpdateAccumulators
...
var OnceBeforeDefault = []Rule{
	...
	{assignInfoSchemaId, loadInfoSchema},
	{validateReadOnlyDatabaseId, validateReadOnlyDatabase},
	{validateReadOnlyTransactionId, validateReadOnlyTransaction},
	{validateDatabaseSetId, validateDatabaseSet},
	{checkPriviledgesId, validatePrivileges}, // Ensure that checking privileges happens after db, table  & table function resolution
...
var OnceAfterDefault = []Rule{
	...
	{modifyUpdateExprsForJoin, modifyUpdateExpressionsForJoin},
	{applyRowUpdateAccumulators, applyUpdateAccumulators},
}
