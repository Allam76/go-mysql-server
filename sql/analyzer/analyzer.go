...
func (a *Analyzer) Analyze(ctx *sql.Context, n sql.Node, scope *Scope) (sql.Node, error) {
	return a.analyzeWithSelector(ctx, n, scope, SelectAllBatches, DefaultRuleSelector)
}
...
func (a *Analyzer) PrepareQuery(ctx *sql.Context, n sql.Node, scope *Scope) (sql.Node, error) {
	return a.analyzeWithSelector(ctx, n, scope, SelectAllBatches, prePrepareRuleSelector)
}
...
func (a *Analyzer) analyzeWithSelector(ctx *sql.Context, n sql.Node, scope *Scope, batchSelector BatchSelector, ruleSelector RuleSelector) (sql.Node, error) {
